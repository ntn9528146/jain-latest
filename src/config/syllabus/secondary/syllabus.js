export const secondarySyllabus = {
  ...
  subjects: {
    ...
    'English Communicative (Code 101)': {
      units: [
        { id: 'ec1', name: 'Reading Skills', marks: 22, subtopics: ['Unseen texts'] },
        { id: 'ec2', name: 'Writing Skills', marks: 22, subtopics: ['Notice, Message, Letters'] },
        { id: 'ec3', name: 'Grammar', marks: 10, subtopics: ['Integrated Grammar'] },
        { id: 'ec4', name: 'Literature Textbook', marks: 26, subtopics: ['Prose, Poetry, Drama'] }
      ]
    },
    ...
    'Information Technology (Code 402)': {
      units: [
        { id: 'it1', name: 'Employability Skills', marks: 10, subtopics: ['Communication, Self-Management, ICT, Entrepreneurial, Green Skills'] },
        { id: 'it2', name: 'Subject Specific Skills', marks: 40, subtopics: ['Digital Documentation', 'Spreadsheets', 'Presentations', 'Database'] }
      ]
    },
    'Artificial Intelligence (Code 417)': {
      units: [
        { id: 'ai1', name: 'Employability Skills', marks: 10, subtopics: ['Communication, Self-Management, ICT, Entrepreneurial, Green Skills'] },
        { id: 'ai2', name: 'Subject Specific Skills', marks: 40, subtopics: ['AI Project Cycle', 'Computer Vision', 'Natural Language Processing', 'Evaluation'] }
      ]
    },
    ...
    'NCC': {
      units: [
        { id: 'ncc1', name: 'Common Subjects', marks: 70, subtopics: ['National Integration, Drill, Weapon Training, Leadership'] }
      ]
    },
    'Art Education': {
      units: [
        { id: 'ae1', name: 'History of Arts', marks: 20, subtopics: ['Cultural heritage and traditions'] },
        { id: 'ae2', name: 'Visual Arts, Music, Theatre, Dance', marks: 16, subtopics: ['Practical art forms'] },
        { id: 'ae3', name: 'Analytical Note on Unseen Image', marks: 4, subtopics: ['Visual evaluation'] }
      ]
    },
    'PEWB': {
      units: [
        { id: 'pe1', name: 'Theory', marks: 20, subtopics: ['Physical Education Concepts, Health & Wellness, Yoga'] },
        { id: 'pe2', name: 'Practical & Sports File', marks: 80, subtopics: ['Skill demonstration and sports file'] }
      ]
    },
